<?php
    ...
    if($resultado){
        header('Location: http://localhost/estacione/estac3/pages/dash.php?page=busca_cliente_atualizar&msg=6');
        mysqli_close($con);
    }else{
        header('Location: http://localhost/estacione/estac3/pages/dash.php?page=busca_cliente_atualizar&msg=7');
    }
