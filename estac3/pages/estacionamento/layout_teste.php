...
let quantidadePavimento =  document.getElementById("quantidadePavimentos");
    // let quantidadePavimento = document.querySelector("#quantidadePavimentos");
    console.log("oi");
    // console.log(quantidadePavimento)
    let quantidadePavimentoValor = quantidadePavimento.value;
    // console.log(quantidadePavimentoValor);
    console.log("vasi");
</script>
<form action="?page=altera_layout_novo" method="post">
    <table>
        <tr>
            <div id="teste">
                <input type="text" id="vagasExistentes" name="vagasExistentes" value="" style="display: none">
                <input type="text" id="rua" name="rua" value="" style="display: none">
            </div>
            <script>
                let vagas = 121;
                let contador = 1;
