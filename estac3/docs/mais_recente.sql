...
REPLACE INTO `estacionamento` (`id_estac`, `nome_estac`, `cnpj_estac`, `num_estac`, `comp_estac`, `preco_estac`, `frac_hr_estac`, `quant_vaga`) VALUES
	(1, 'Estacione Aqui', '166666', '33', 'sla', 4, 2, '20');
...
REPLACE INTO `funcionario` (`id_func`, `nome_func`, `nivel_func`, `email_func`, `status_func`, `dt_cadastro_func`, `cpf_func`) VALUES
	(1, 'bia', '1', 'bia@gmail.com', '1', '2022-09-06 06:33:58', '11112'),
...
REPLACE INTO `ticket` (`id_ticket`, `hr_entrada`, `hr_saida`, `valor_total_ticket`, `chave`, `placa_veic`, `id_vaga`) VALUES
	...
	(18, '2022-07-01 11:39:18', '2022-07-02 07:38:54', 0, '0', 'ABC1234', 1);
...
-- Copiando dados para a tabela sistema_ge.vagas: ~21 rows (aproximadamente)
/*!40000 ALTER TABLE `vagas` DISABLE KEYS */;
REPLACE INTO `vagas` (`id_vagas`, `status_vaga`, `pav_vaga`, `tipo_vaga`, `id_estac`, `setor_vaga`, `num_vaga`) VALUES
	(0, '0', '1', '0', 1, 'A', '0'),
	(1, '0', '1', '0', 1, 'A', '1'),
	(2, '1', '1', '0', 1, 'A', '2'),
	(3, '1', '1', '0', 1, 'A', '3'),
...
REPLACE INTO `veiculo` (`placa_veic`, `tipo_veic`, `id_cli`) VALUES
	('ABC1234', '1', 54),
	('KRZ4605', '0', 37),
	('KUR9257', '0', 53),
	('KWR1635', '1', 49),
